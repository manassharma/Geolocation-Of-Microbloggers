...
# text to vectors conversion is as taken from : https://radimrehurek.com/gensim/tut1.html"
from gensim.models import LdaModel

documents = ["Looking forward to the Taken King expansion  RedBull is doing a promo",
             "  RedBullQuest",
